class Woning:
    def __init__(self, naam:str, smarthub_object):
        ...
        if self.smarthub:
            ...
            try:
                ...
                print(f"Waarschuwing: Smarthub obj heeft gn set_woning methode,"
    ...
    def voeg_kamer_toe(self, kamer_obj):
        if kamer_obj.naam not in self.kamers:
            ...
            print(f"Debug: kamer {kamer_obj.naam} toegevoegd aan {self.naam}")
        else:
            print(f"DEBUG: kamer{kamer_obj.naam} bestaat al in woning.")
    ...
    def voeg_bewoner_toe(self, bewoner_obj):
        if bewoner_obj not in self.bewoners:
            ...
            print(f"DEBUG: Bewoner {bewoner_obj.naam} toegevoegd aan {self.naam}")
        else:
            print(f"DEBUG: Bewoner {bewoner_obj.naam} al in woning aanwezig.")
